    ...
    <div class="container-fluid">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <h3><i class="fa fa-user-graduate"></i> Ingreso de Calificaciones</h3>
                <p>Puede ingresar las calificaciones de cada estudiante para cada asignatura asociada al curso.</p>
                ...
                <div class="panel panel-primary" id="panel-datos">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <select name="semestre" id="semestre" class="form-control" onchange="cargarCalificaciones()"
                        ...
                        <div class="form-group">
                            ...
                            <select name="asignatura" id="asignatura" class="form-control"
                                onchange="cargarCalificaciones()" onclick="esconderMensaje()">
