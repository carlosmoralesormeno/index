...
<div class="page-hero page-container " id="page-hero">
    <div class="padding d-flex">
        <div class="page-title">
            <h2 class="text-md text-highlight">Resultados de Evaluaciones</h2>
            <small class="text-muted">Resultados de Evaluaciones Compartidas</small>
        </div>
        <div class="flex"></div>
        <div>
            <button id="btn-new" class="btn btn-info btn-margin"
                onclick="<?php echo 'cargarResultadoEvaluacion()';?>"><i class="fas fa-poll-h"></i>
            </button>
...
<?php echo '<script>cargarResultadoEvaluacion()</script>';?>
