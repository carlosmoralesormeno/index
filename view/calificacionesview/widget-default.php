    ...
    <div class="container-fluid">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <h3><i class="fa fa-user-graduate"></i> Calificaciones</h3>
                <p>En este módulo podrá revisar las calificaciones del curso seleccionado.</p>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <select name="semestre" id="semestre" class="form-control"
                                onchange="cargarVistaCalificaciones()">
