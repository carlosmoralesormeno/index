...
<section>
    ...
    <p>Visualice la información del estudiantes que actualmente se encuentra registrado en el sistema</p>
    <div class="table-responsive">

        <table class="table table-sm table-bordered">

            <tr class="th-color">
                <th colspan="15" scope="col"> <i class="fa fa-user-graduate"></i> Datos del Estudiante</th>
            </tr>
            ...
            <tr class="th-color-2">
                <th colspan="15" scope="col"><i class="fa fa-user"></i> Datos del Apoderado</th>
            </tr>
            ...
            <?php
                ...
                ?>
            <tr class="th-color-2">
                <th colspan="15" scope="col"><i class="fa fa-users"></i> Apoderados Suplentes</th>
            </tr>
            <tr class="th-color-cell-2">
            ...
            <?php
                ...
                ?>
            <tr class="th-color-3">
                <th colspan="15" scope="col"><i class="fa fa-book-open"></i> Datos de Matrícula</th>
            </tr>
